import os
from dataset_cate import Dataset_train, Dataset_val
...
if args.net.lower() == 'resnet34':
    net = Resnet34(classes=1).cuda()
if args.net.lower() == 'resnet18':
    net = Resnet18(classes=1).cuda()
if args.net.lower() == 'se_resnet50':
    net = Se_Resnet50(classes=1).cuda()
